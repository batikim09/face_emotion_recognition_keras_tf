...
if __name__ == '__main__':
    ...
    parser.add_argument("-gender_model", "--gender_model_path", dest= 'gender_model_path', type=str, help="indice of test sets, separated by commas", default = './trained_models/gender_models/simple_CNN.81-0.96.hdf5')
    ...
    gender_classifier = load_model(args.gender_model_path, compile=False)
